...
\lstinputlisting[caption=TODO,label=dmi_proc_m1,language=,]{listings/dmidecode_processor}
\lstinputlisting[caption=TODO,label=dmi_proc_m1,language=,]{listings/machine1_uname}
%\textbf{Machine 1:}\\
